...
public:
    ...
    /**
     * @brief Construtor default da classe grafo
     * 
     */
    Graph() = default;
...
private:
    ...
    /**
     * @brief Função que popula um vector com os cliques maximais, usando o algoritmo de Bron Kerbosh que foi passado em sala.
     * 
     * @param click 
     * @param possible 
     * @param excluded 
